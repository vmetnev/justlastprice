...
async function earningsHistoryController(req, res) {
    ...
    structure0.earnHistQuarterEndMinus1Q = new Date(data[0].quarter).toISOString().split('T')[0]
    structure0.earnHistEpsActualMinus1Q = data[0].epsActual
    structure0.earnHistEpsEstimateMinus1Q = data[0].epsEstimate
    structure0.earnHistDiffMinus1Q = data[0].surprisePercent

    structure1.earnHistPeriodMinus2Q = data[1].period
    structure1.earnHistQuarterEndMinus2Q = new Date(data[1].quarter).toISOString().split('T')[0]
    structure1.earnHistEpsActualMinus2Q = data[1].epsActual
    structure1.earnHistEpsEstimateMinus2Q = data[1].epsEstimate
    structure1.earnHistDiffMinus2Q = data[1].surprisePercent

    structure2.earnHistPeriodMinus3Q = data[2].period
    structure2.earnHistQuarterEndMinus3Q = new Date(data[2].quarter).toISOString().split('T')[0]
    structure2.earnHistEpsActualMinus3Q = data[2].epsActual
    structure2.earnHistEpsEstimateMinus3Q = data[2].epsEstimate
    structure2.earnHistDiffMinus3Q = data[2].surprisePercent

    structure3.earnHistPeriodMinus4Q = data[3].period
    structure3.earnHistQuarterEndMinus4Q = new Date(data[3].quarter).toISOString().split('T')[0]
    structure3.earnHistEpsActualMinus4Q = data[3].epsActual
    structure3.earnHistEpsEstimateMinus4Q = data[3].epsEstimate
    structure3.earnHistDiffMinus4Q = data[3].surprisePercent
